...
{
    /**
     * Affiche tous les tickets attribués aux utilisateurs.
     *
     * @OA\Get(
     * path="/api/tickets/assigned",
     * tags={"Attribution des Tickets"},
     * summary="Liste de toutes les attributions de tickets et utilisateurs.",
     * description="Récupère la liste des objets TicketUser, en incluant l'utilisateur (user) et le ticket associé (ticket) via l'Eager Loading.",
     * @OA\Response(
     * response=200,
     * description="Liste des attributions d'utilisateurs et de tickets.",
     * @OA\JsonContent(
     * type="array",
     * @OA\Items(
     * @OA\Property(property="id", type="integer", example=1),
     * @OA\Property(property="ticketinstance_id", type="integer", example=101),
     * @OA\Property(property="user_id", type="integer", example=5),
     * @OA\Property(
     * property="user", 
     * description="L'utilisateur attribué.",
     * @OA\Property(property="id", type="integer", example=5),
     * @OA\Property(property="name", type="string", example="Jean Dupont"),
     * ),
     * @OA\Property(
     * property="ticketinstance",
     * description="Le ticket attribué.",
    ...
    {
        $ticketagents = Ticketagent::get();

        return response()->json($ticketagents);
    }
     ...
     */
    public function show(Ticketagent $ticketagent)
    {
        //
    }
